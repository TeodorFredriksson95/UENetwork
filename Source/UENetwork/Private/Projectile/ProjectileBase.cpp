...
#include "UENetwork/Public/Projectile/ProjectileBase.h"
...
AProjectileBase::AProjectileBase()
{
	...
	{
         SphereComponent->OnComponentHit.AddDynamic(this, &AProjectileBase::OnProjectileImpact);	}
